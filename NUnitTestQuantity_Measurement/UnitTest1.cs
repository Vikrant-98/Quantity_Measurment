...
namespace Tests
{
    public class Tests
    {
        ...
        /// <summary>
        /// TC-1.19 Value check for 36 Inch Equal 1 Yard
        /// </summary>
        [Test]
        public void Given_Input_Check_For_Value_Check_for_Equality_36_Inch_to_1_Yard()
        {
            double actual = type.Inch_to_Yard(36);
            double expected = 1;
            Assert.AreEqual(expected, actual);
        }
        /// <summary>
        /// TC-1.20 Value check for 1 Yard Equal 3 Feet
        /// </summary>
        [Test]
        public void Given_Input_Check_For_Value_Check_for_Equality_1_Yard_to_3_Feet()
        {
            double actual = type.Yard_to_Feet(1);
            double expected = 3;
            Assert.AreEqual(expected, actual);
